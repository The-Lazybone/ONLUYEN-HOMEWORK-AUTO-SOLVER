...
Developed and tested using the Pollinations.ai proxy. Thanks to [Pollinations.ai](https://pollinations.ai/) for providing the API/proxy used during development.
